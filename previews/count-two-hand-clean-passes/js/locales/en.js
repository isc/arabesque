...
export default {
  ...
  criteria: {
    ...
    cleanMeasures: '{percent}% of the measures played clean with both hands at least {n} times',
    cleanMeasuresAll: 'Every measure played clean with both hands at least {n} times',
  ...
  journal: {
    untitled: 'Untitled',
    playedFullOne: 'Played in full',
    playedFull: 'Played {n}× in full',
  ...
  score: {
    ...
    trainerGraduated: 'Graduated (+{step} BPM / {streak} clean)',
    ...
    loopRun: 'run {n}',
    loopStreak: '{n} of {streak} clean',
    trainingBand: '🎯 Training',
    trainingHint: 'Each bar must be played {times}× without a mistake.',
    trainingLoopTitle: 'Work a whole passage: click its first bar, then its last',
    trainingPassage: 'Bars {from} to {to}: the whole passage must be played {times}× without a mistake.',
    trainingPassageOne: 'Bar {from} on its own: it must be played {times}× without a mistake.',
    ...
    strictRuns: 'strict mode',
    strictRunSummary: '{pct}% at {bpm} BPM',
    percent: '{pct}%',
    trainingDone: 'You completed every bar of the piece.',
    trainingPassageDone: 'You played bars {from} to {to} {times}× in a row without a mistake.',
    trainingPassageDoneOne: 'You played bar {from} {times}× without a mistake.',
    ...
    resultTitleTrainer: '🔁 Loop finished',
    trainerNoRun: 'No run played to the end.',
    trainerRunsOne: '{n} run',
    trainerRuns: '{n} runs',
    trainerClean: '{n} clean',
    trainerTempo: 'from {from} to {to} BPM',
    trainerTempoSame: 'at {from} BPM',
    trainerBestStreak: 'best streak: {n} clean in a row',
