...
const PENDING = [{"date":"2026-09-26","items":{"fr":["Mode micro (bêta) : sans clavier MIDI, le bouton 🎤 de la page partition écoute votre piano par le microphone. Une note à la fois pour l'instant : les accords ne sont pas encore reconnus."],"en":["Mic mode (beta): without a MIDI keyboard, the 🎤 button on the score page listens to your piano through the microphone. One note at a time for now: chords aren't recognised yet."]}},{"date":"2026-09-25","items":{"fr":["L'Ave Maria de Schubert transcrit par Liszt rejoint la bibliothèque, à côté de l'arrangement simple. Le chant est sur une portée du milieu, partagé entre les deux pouces : chaque note va à la main qu'indique sa hampe, comme Liszt l'écrit.","Les doigtés ne se posent plus sur les ornements. Sur une note ornée reliée à d'autres par une barre, comme le mordant de la mesure 34 du Prélude en do mineur de Bach, le doigté passe au-dessus du signe.","L'historique d'une partition donne les fausses notes de chaque passage. Elles suivent le temps du passage, comme dans la fenêtre de fin de morceau.","Les statuts ne comptent plus les passages à une main. Pour Perfectionnement et Répertoire, une mesure compte quand elle est jouée proprement mains ensemble : un morceau travaillé mains séparées peut redescendre d'un cran.","La Rêverie de Schumann rejoint la bibliothèque. Träumerei, no 7 des Scènes d'enfants, doigtée aux deux mains : vingt-quatre mesures où le chant passe d'une main à l'autre."],"en":["Liszt's transcription of Schubert's Ave Maria joins the library, beside the simple arrangement. The melody sits on a middle staff shared by both thumbs: each note goes to the hand its stem points to, as Liszt wrote it.","Fingerings no longer sit on ornaments. On an ornamented note beamed to others, like the mordent in bar 34 of Bach's C minor Prelude, the fingering now clears the sign.","A score's history gives each run's wrong notes. They follow the run's time, as in the window shown at the end of a piece.","Statuses no longer count one-hand passes. For Perfectionnement and Répertoire, a bar counts once it is played clean with both hands, so a piece worked hands apart may drop back a step.","Schumann's Träumerei joins the library. The seventh of the Scenes from Childhood, fingered for both hands: twenty-four bars of a melody handed from one hand to the other."]}},{"date":"2026-09-24","items":{"fr":["La bibliothèque ne se réveille plus vide. Rouverte le lendemain dans l'app iPad, elle pouvait perdre le statut et le temps de pratique de chaque morceau, et garder le journal de la veille, jusqu'à ce qu'on la recharge.","Un doigté reste sur la note où vous l'avez écrit. Sur certaines partitions, comme la Gnossienne nº 1 ou L'Entertainer, il pouvait réapparaître sur d'autres mesures ou passer d'une main à l'autre. Vos doigtés enregistrés sont repris sans rien perdre."],"en":["The library no longer wakes up empty. Reopened the next day in the iPad app, it could lose every piece's status and practice time, and keep the day before's journal, until it was reloaded.","A fingering stays on the note you wrote it on. On some scores, such as Gnossienne No. 1 or The Entertainer, it could reappear on other measures or jump from one hand to the other. Fingerings you already saved carry over, nothing lost."]}},{"date":"2026-09-23","items":{"fr":["L'écoute joue les arpèges. Un accord marqué d'un signe d'arpège s'égrène de la basse vers l'aigu au lieu d'être plaqué, sur les deux portées d'un seul geste quand les deux mains le portent.","Un clavier vient en aide quand une note ne se trouve pas. Après trois fausses notes, ou huit secondes d'hésitation, un clavier s'affiche sous la partition avec la touche à jouer allumée. Il repart de lui-même quand les notes s'enchaînent, et le ✕ le range.","Les fausses notes d'un morceau joué en libre s'affichent. Le classement de fin indique, à côté de chaque temps, le nombre de fausses notes, et nomme les mesures où elles sont tombées.","Une mesure se choisit sur toute sa hauteur. Quand une main se tait, on peut désormais cliquer sur sa portée pour reprendre à cette mesure.","▶ Écouter joue plus doucement. Le morceau sort maintenant de l'instrument à une nuance piano, sous son propre toucher : plus besoin de baisser le volume avant d'écouter et de le remonter pour jouer.","Le filtre « À renforcer » ne retient plus tous les morceaux joués. Il garde ceux où une mesure accroche au moins deux fois plus souvent que la moyenne du morceau : un morceau fragile partout reste une affaire de lecture, pas de quelques mesures.","Les mesures à renforcer suivent les mains cochées. Main droite seule, seules les mesures ratées main droite sont proposées, et le bouton l'indique ; à deux mains, seules celles ratées à deux mains.","Le verdict d'un playthrough strict survit à une rotation de l'écran. Les notes marquées ne tenaient qu'au dessin de la partition : le moindre changement de largeur les effaçait, et elles ne revenaient plus.","« Sur le chemin de l'école » rejoint le recueil Chansons. Une chanson en sol majeur, où la main droite joue sol, fa dièse, sol, paroles sous les notes."],"en":["Listening plays arpeggios. A chord marked with an arpeggio sign rolls from the bass up instead of being struck at once, across both staves in one sweep when both hands carry it.","A keyboard steps in when a note can't be found. After three wrong notes, or eight seconds of hesitation, a keyboard appears under the score with the key to play lit up. It leaves on its own once the notes flow, and the ✕ puts it away.","Wrong notes in a free run are shown. The end-of-piece ranking gives each time its wrong-note count, and names the bars they fell in.","A measure can be picked across its whole height. When one hand rests, clicking its staff now starts from that measure too.","▶ Écouter plays more softly. The piece now comes out of the instrument at a piano, under your own touch: no more turning the volume down to listen and back up to play.","The \"To reinforce\" filter no longer holds every piece played. It keeps the ones where a bar is fumbled at least twice as often as the piece on average: a piece shaky all over is still a matter of reading, not of a few bars.","Bars to reinforce follow the hands ticked. With the right hand alone, only bars fumbled right-handed are offered, and the button says so; with both hands, only those fumbled with both.","A strict playthrough's verdict survives a screen rotation. The marked notes were held by the drawing of the score alone: the first change of width wiped them, and they never came back.","\"Sur le chemin de l'école\" joins the Chansons collection. A song in G major where the right hand plays G, F sharp, G, with the words under the notes."]}},{"date":"2026-09-22","items":{"fr":["Changer de main recommence la mesure en cours. Recocher la main gauche en milieu de mesure ne réclame plus ses notes déjà passées, et la mesure se rejoue depuis son premier temps, les deux mains ensemble.","La Marche turque de Beethoven entre dans la bibliothèque, dans la transcription pour piano d'Anton Rubinstein — une pièce de concert, en octaves et accords aux deux mains.","Les notes marquées par un playthrough strict s'effacent quand on change de main. Le verdict portait sur les mains jouées : il ne reste plus en rouge sur des notes que la tentative suivante ne demandera pas. Les cases Main droite / Main gauche se figent le temps d'un run."],"en":["Changing hands starts the current measure over. Ticking the left hand back mid-measure no longer asks for the notes it missed, and the measure plays again from its first beat, both hands together.","Beethoven's Turkish March joins the library, in Anton Rubinstein's piano transcription — a concert piece, octaves and chords in both hands.","The notes a strict playthrough marks are cleared when a hand is switched off. The verdict was a verdict on the hands played, and no longer stays red over notes the next attempt will not ask for. The hand boxes are frozen for the length of a run."]}},{"date":"2026-09-21","items":{"fr":["L'Invention n° 1 de Bach rejoint la bibliothèque, doigtée, et vérifiée note à note contre l'édition de la Bach-Gesellschaft.","Un trille sur une note liée se tient jusqu'au bout de la liaison, même quand l'autre main joue. L'Invention n° 4 de Bach en porte deux, écrits en trilles."],"en":["Bach's Invention No. 1 joins the library, fingered, and checked note by note against the Bach-Gesellschaft edition.","A trill on a tied note holds to the end of the tie, even while the other hand plays. Bach's Invention No. 4 has two, now written as trills."]}},{"date":"2026-09-18","items":{"fr":["Les ornements suivent les altérations de la mesure. Un mordant placé après un bécarre descend sur la note bécarre, plus sur celle de l'armure."],"en":["Ornaments follow the accidentals of their measure. A mordent written after a natural dips to the natural note, no longer to the one in the key signature."]}},{"date":"2026-09-16","items":{"fr":["Les ronds du mode entraînement restent visibles. Le défilement automatique les dégage des barres du haut, y compris sur une mesure qui monte loin au-dessus de la portée."],"en":["The training dots stay in view. The autoscroll clears them of the sticky bars, including on a bar that climbs far above the staff."]}},{"date":"2026-09-14","items":{"fr":["Arabesque est sur l'App Store. Sur iPhone et iPad, l'app fait le pont avec le clavier MIDI, en USB comme en Bluetooth."],"en":["Arabesque is on the App Store. On iPhone and iPad, the app bridges to the MIDI keyboard, over USB or Bluetooth."]}},{"date":"2026-09-12","items":{"fr":["« Trompette et tambour » rejoint le recueil Chansons. La main droite sonne la fanfare, la gauche bat le tambour, et les paroles sont écrites sous les notes."],"en":["\"Trompette et tambour\" joins the Chansons collection. The right hand sounds the fanfare, the left beats the drum, and the words sit under the notes."]}},{"date":"2026-09-10","items":{"fr":["Le journal de pratique ne perd plus le titre d'une partition récente. Une synchronisation pouvait la renommer « Sans titre » ; les pièces déjà touchées retrouvent leur nom à la prochaine lecture.","La recherche de la bibliothèque ignore les accents. Taper « burgmuller » trouve Burgmüller, et un tréma en trop ne cache plus rien.","Les notes marquées par un playthrough strict s'effacent quand on choisit un autre passage. Le verdict portait sur le passage joué : il ne reste plus en rouge sur des mesures dont la boucle est sortie."],"en":["The practice journal no longer loses the title of a recently added score. A sync could rename it \"Untitled\"; a piece already hit gets its name back the next time it is played.","The library search ignores accents. Typing \"burgmuller\" finds Burgmüller, and an umlaut too many no longer hides anything.","The notes a strict playthrough marks are cleared when another passage is picked. The verdict was a verdict on the passage played, and no longer stays red over bars the loop has left behind."]}},{"date":"2026-09-09","items":{"fr":["La Ballade de Burgmüller rejoint la bibliothèque. L'étude op. 100 no 15, en ut mineur, doigtée aux deux mains et avec ses reprises.","La Consolation de Burgmüller rejoint la bibliothèque. L'étude op. 100 no 13, doigtée, quarante-deux mesures où la main droite dessine son motif au-dessus d'accords tenus.","L'Harmonie des anges de Burgmüller rejoint la bibliothèque. L'étude op. 100 no 21, doigtée aux deux mains, où l'arpège passe d'une main à l'autre sans qu'on l'entende.","Sur iPad, connecter un clavier ouvre la fenêtre du système. Le bouton « Connecter clavier MIDI » affichait des instructions pour macOS ; il ouvre maintenant l'appairage Bluetooth de l'iPad, et le menu ⚙️ le propose aussi.","Le filtre « À renforcer » oublie les vieilles fautes. Il lisait des compteurs cumulés depuis le premier jour, et un morceau massacré il y a six mois y restait à vie. Il pose maintenant la même question que le mode renforcement : reste-t-il des mesures à retravailler sur les dix dernières séances ?","« Pas joué depuis 7 j » ne rappelle plus les morceaux jamais commencés. Une partition ouverte trente secondes n'a pas de badge, mais revenait quand même dans la liste. Il lui faut désormais une minute de travail, comme pour le badge. Et la carte sous la liste dit ce que le filtre sélectionne."],"en":["Burgmüller's Ballade joins the library. The op. 100 no. 15 study in C minor, fingered for both hands, repeats and all.","Burgmüller's Consolation joins the library. The op. 100 no. 13 study, fingered, forty-two bars of a right-hand figure over held chords.","Burgmüller's Harmony of the Angels joins the library. The op. 100 no. 21 study, fingered for both hands, its arpeggio passing from one to the other unheard.","On iPad, connecting a keyboard opens the system sheet. The \"Connect MIDI keyboard\" button used to show macOS instructions; it now opens the iPad's own Bluetooth pairing, and the ⚙️ menu offers it too.","The \"To reinforce\" filter forgets old mistakes. It read counters adding up from the very first day, so a piece massacred six months ago stayed on the list for ever. It now asks the same question reinforcement mode does: are there bars still worth working on over the last ten sessions?","\"Not played in 7d\" no longer reminds you of pieces you never started. A score opened for thirty seconds carries no badge, yet still came back on the list. It now needs a minute of practice, the same floor as the badge. And the card under the list says what the filter selects."]}},{"date":"2026-09-08","items":{"fr":["Les ornements sont attendus en mode strict. Une note ornée n'était jamais validée, et la jouer comptait pour une fausse note. Le mode demande maintenant la réalisation écrite — mordant, grupetto, trille — dans l'ordre, un trille alternant à volonté. L'ornement omis compte pour une note manquée."],"en":["Ornaments are expected in strict mode. An ornamented note was never validated, and playing it even counted as a wrong note. The mode now asks for the written realization — mordent, turn, trill — in its order, a trill alternating as long as you like. Leaving the ornament out counts as a missed note."]}},{"date":"2026-09-07","items":{"fr":["Le tempo se règle au doigt. Un − et un + encadrent le champ, en mode strict comme à l'écoute : une pression pour un cran de 5 BPM, un appui maintenu pour défiler. Taper la valeur au clavier marche toujours.","Le badge Déchiffrage se mérite. Une partition ouverte et essayée quelques secondes s'affichait déjà comme déchiffrée ; il faut désormais une minute de jeu sur le morceau, le temps affiché juste à côté du badge.","Les filtres de la bibliothèque ne se contredisent plus. « Déchiffrage » puis « Proches du répertoire » répondait par une liste vide : le filtre sur lequel on clique s'applique désormais toujours, en relâchant celui qui l'en empêchait, et chaque compteur annonce ce que le clic va afficher.","La modale de doigté dit sur quelle note elle porte. Son titre affiche le nom de la note cliquée et sa main — « sol♯5 · main droite » — de quoi vérifier d'un coup d'œil, sur une partition dense, que le clic a bien atteint la tête visée.","Chaque profil se synchronise avec le compte. Seul le premier suivait le compte, les autres restaient sur leur appareil. Un profil créé sur l'iPad apparaît maintenant sur le téléphone connecté au même compte, avec son journal, ses statuts et ses doigtés ; supprimé quelque part, il l'est partout.","Le repère de la mesure de départ s'efface pendant un passage strict. Il restait posé sur la mesure choisie longtemps après qu'on l'avait dépassée ; il ne marque plus que le départ du prochain essai, et revient si on arrête le passage."],"en":["The tempo can be set with a thumb. A − and a + now flank the field, in strict mode and while listening: one press moves it by 5 BPM, a held press keeps it moving. Typing the value in still works.","The Sight-reading badge is earned. A score opened and tried for a few seconds already showed up as being sight-read; it now takes a minute of playing on the piece, the time shown right next to the badge.","The library filters no longer contradict each other. \"Sight-reading\" then \"Close to the repertoire\" answered with an empty list: the filter you click now always applies, releasing whichever one stood in its way, and every count says what the click will show.","The fingering pad says which note it is about. Its title now shows the name of the note you clicked and its hand — \"G♯5 · right hand\" — so on a dense score you can see at a glance that the click landed on the head you meant.","Every profile syncs with the account. Only the first one followed it, the others stayed on their device. A profile created on the iPad now shows up on the phone signed in to the same account, with its journal, statuses and fingerings; removed anywhere, it is removed everywhere.","The start-measure marker clears while a strict run plays. It used to sit on the chosen measure long after the player had passed it; it now marks only where the next run begins, and comes back if a run is stopped."]}},{"date":"2026-09-06","items":{"fr":["Les critères du statut suivant, sous la liste. Filtrer la bibliothèque sur Déchiffrage, Perfectionnement ou « Proches du répertoire » affiche maintenant, sous les partitions, ce qu'il faut atteindre pour passer au statut au-dessus.","Un avis part avec l'image de l'écran qu'on avait sous les yeux. Un problème se décrivait mal en mots : la mesure fautive n'a pas de nom, et l'état de la page ne se raconte pas. La fenêtre d'avis joint maintenant une capture, montrée avant l'envoi et retirable d'une case.","Le clavier se connecte tout seul une fois appairé. Sur iPad, l'appairage Bluetooth se fait hors de l'app : au retour, les notes passaient déjà, mais l'en-tête proposait toujours « Connecter clavier MIDI ». L'app écoute maintenant l'arrivée du clavier, et signale aussi bien un débranchement.","▶ Écouter a son propre bandeau. Le morceau écouté se pilotait d'un seul bouton : ▶ depuis le début, ⏹ pour tout arrêter. Un bandeau offre maintenant ⏸ / ▶ pour reprendre à la mesure laissée, le tempo d'écoute modifiable en cours de route, et un clic sur une mesure pour écouter à partir de là.","Travaillez un passage entier en mode entraînement. La sélection ne portait que sur une mesure ; le bouton 🔁 de la barre d'entraînement permet maintenant de cliquer la première puis la dernière mesure d'un passage, qui doit sortir trois fois de suite sans faute — enchaînements et liaisons compris."],"en":["The criteria for the next status, under the list. Filtering the library on Sight-reading, Refining or \"Near repertoire\" now shows, under the scores, what it takes to reach the status above.","Feedback goes out with a picture of the screen you were looking at. A problem was hard to put into words: the offending bar has no name, and the state of the page does not tell itself. The feedback window now attaches a capture, shown before you send and taken back off with a checkbox.","The keyboard connects on its own once paired. On an iPad the Bluetooth pairing happens outside the app: on the way back the notes were already coming through, but the header still offered \"Connect MIDI keyboard\". The app now listens for the keyboard arriving, and reports an unplug just as promptly.","▶ Écouter has a band of its own. The piece being listened to was driven by a single button: ▶ from the top, ⏹ to end it. A band now offers ⏸ / ▶ to pick the piece up at the bar it was left at, the listening tempo changed while it plays, and a click on any bar to hear it from there.","Work a whole passage in training mode. Only one bar could be selected; the 🔁 button in the training band now lets you click a passage's first bar and then its last, and the whole thing has to come out three times in a row without a mistake — the joins and slurs between bars included."]}}]
