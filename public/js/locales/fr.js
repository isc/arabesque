...
export default {
  ...
  profiles: {
    ...
    delete: 'Supprimer',
    deleteWarning:
      'Tout ce que {name} a joué sera effacé : journal, statuts, doigtés, sur cet appareil comme sur les autres appareils connectés au compte.',
  ...
  library: {
    ...
    tabJournal: 'Journal',
    tabScores: 'Partitions',
    tabsAria: 'Vue',
    filters: 'Filtrer',
    sortAria: 'Trier les partitions',
    sortLastPlayed: 'Joué récemment',
    colTitle: 'Titre',
  ...
  score: {
    ...
    trainerGraduated: 'Progressif (+{step} BPM / {streak} propres)',
    ...
    loopRun: 'passage {n}',
    loopStreak: '{n} sur {streak} propres',
    trainingBand: '🎯 Entraînement',
    trainingHint: 'Chaque mesure doit être jouée {times}× sans erreur.',
    trainingLoopTitle: 'Travailler un passage entier : cliquez sur sa première puis sa dernière mesure',
    trainingPassage: 'Mesures {from} à {to} : le passage entier doit être joué {times}× sans erreur.',
    trainingPassageOne: 'Mesure {from} seule : elle doit être jouée {times}× sans erreur.',
    ...
    strictRuns: 'mode strict',
    strictRunSummary: '{pct} % à {bpm} BPM',
    percent: '{pct} %',
    trainingDone: 'Vous avez complété toutes les mesures du morceau.',
    trainingPassageDone: 'Vous avez enchaîné les mesures {from} à {to} {times}× sans erreur.',
    trainingPassageDoneOne: 'Vous avez joué la mesure {from} {times}× sans erreur.',
    ...
    resultTitleTrainer: '🔁 Boucle terminée',
    trainerNoRun: 'Aucun passage joué jusqu\'au bout.',
    trainerRunsOne: '{n} passage',
    trainerRuns: '{n} passages',
    trainerClean: '{n} propres',
    trainerTempo: 'de {from} à {to} BPM',
    trainerTempoSame: 'à {from} BPM',
    trainerBestStreak: 'meilleure série : {n} propres d\'affilée',
